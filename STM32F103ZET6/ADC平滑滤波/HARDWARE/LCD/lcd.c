...
{
	POINT_COLOR=BLUE;	  
	LCD_ShowString(10,40,210,24,24,"MODE:");
	POINT_COLOR=RED;
	LCD_ShowNum(120,40,Mode,1,24);
	
	POINT_COLOR=BLUE;	  
	LCD_ShowString(10,80,200,24,24,"Angle_select:");
	POINT_COLOR=RED;
	LCD_ShowNum(180,80,Angle_Mode,1,24);
	
	POINT_COLOR=BLUE;
	LCD_ShowString(10,120,200,24,24,"Angle_0:");
	POINT_COLOR=RED;
	LCD_ShowNum(120,120,Angle_0,3,24);
	
	POINT_COLOR=BLUE;
	LCD_ShowString(10,160,200,24,24,"Angle_1:");
	POINT_COLOR=RED;
	LCD_ShowNum(120,160,Angle_1,3,24);
	
	POINT_COLOR=BLUE;
	LCD_ShowString(10,200,200,24,24,"Start:");
	POINT_COLOR=RED;
	LCD_ShowNum(120,200,Start,3,24);	
	
	Angle=Get_Angle_Average();//获取角度的值
	POINT_COLOR=BLUE;
	LCD_ShowString(10,240,200,24,24,"Angle:");
	POINT_COLOR=RED;
	LCD_ShowNum(120,240,Angle,3,24);
}
//写寄存器函数
//regval:寄存器值
